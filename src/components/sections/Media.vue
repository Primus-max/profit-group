<template>
    <BaseSection background="var(--color-white)" height="700px" :z-index="10" has-radius>        
        <div class="media-section__container">
            ...
            <div class="media__content">
                <div  v-for="video in podcasts" :key="index">
                    <Video :video="video" />
                </div>                              
                ...
                <div v-for="video in videoClips" :key="video.id" >
                    <Video :video="video" />
                </div>
                <hr width="100%" size="2" color="gray" class="seporator">
                 <!-- стрелки -->
