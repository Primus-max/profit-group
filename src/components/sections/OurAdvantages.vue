        ...
        <div class="advantages_container">
            ...
            <div class="advantages_content">
                ...
                <div v-for="(advantage, index) in infos" :key="advantage.id">
                    <Advantage 
                        :info="advantage" 
                        :class="index % 2 === 0 ? 'blue_background' : 'black_background'"
                    >
                        <component 
                            :is="advantage.icon" 
                            :color="colorIcon" 
...
const infos = [
    {
        ...
        description: "Мы предлагаем комплексные правовые решения, специализируюясь на потребности бизнеса, комбинируя юридическую практику, уникальный опыт и индивидуальный подход.",
        icon: FolderIcon
    },
    {
        id: 1,
